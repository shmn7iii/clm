						...
						<div class="py-2">
							<div class="sm:flex sm:items-center sm:justify-between">
								<span class="text-sm text-gray-500 sm:text-center">
									© 2024 <a href="https://github.com/shmn7iii" class="hover:underline">shmn7iii</a>. All Rights Reserved.
								</span>
								<div class="flex mt-4 sm:justify-center sm:mt-0">
									<a href="https://github.com/shmn7iii/clm">
										<svg
											xmlns="http://www.w3.org/2000/svg"
											width="24"
											height="24"
											viewBox="0 0 24 24"
											style="fill: #808080; height: 20; width: 24;"
										>
											<path
